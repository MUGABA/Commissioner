    ...
    <TopbarRoot>
      <TopbarContainer>
        <Box display="flex">
          ...
          {user.userSide === 'Patient' ? (
            <>
              <UserMenu>
                <Hidden xsDown>
                  <Span>
                    <Link to="/dashboard/ask-diet-help">Request Diet Help</Link>
                  </Span>
                </Hidden>
              </UserMenu>
          ...
          {user.userSide === 'Doctor' ? (
            <>
              <UserMenu>
                <Hidden xsDown>
                  <Span>
                    <Link to="/dashboard/view-patient-requests">View Requests</Link>
                  </Span>
                </Hidden>
              </UserMenu>
            </>
